...
export default function FinalServiceCTA({
  ...
  const handleSubmit = async (e) => {
    ...
    if (selected === "Select a challenge") {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className="flex-1 px-8 py-4 bg-primary text-white rounded-lg font-semibold text-lg flex items-center justify-center gap-2 disabled:opacity-60"
                  >
                    {loading ? "Submitting..." : primaryCta.text}
                  </motion.button>
